...
window.gplQuickOrderV2 = function (sectionId) {
  ...
  const base = {
    ...
    persistKey() { return 'gpl-customizer-v2-' + config.productId; },
    persist() {
      try {
        const art = {};
  ...
  // v2: editor methods override the single-image editor above (see gpl-customizer-v2-editor.js)
  return Object.assign(base, window.gplEditorMixin || {});
};
